...
export const RestoreIcon = ({ size = 16 }) => (
  <svg
    fill="none"
    height={size}
    stroke="currentColor"
...
export const AssignIcon = (props: IconSvgProps) => (
  <svg
    fill="currentColor"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M7 7h2v2H7zM11 7h6v2h-6zM7 11h2v2H7zM11 11h6v2h-6zM7 15h2v2H7zM11 15h6v2h-6z" />
  </svg>
);
